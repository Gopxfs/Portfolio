...
const projects = [
  {
    name: 'Pokemon hunt website (fake event)',
    ...
    image: 'images/project-images/pokemon-page-desktop.png',
    technologies: ['html', 'Ruby on rails', 'css', 'Github'],
    liveVersion: 'https://gopxfs.github.io/Pokemon-hunt/',
    source: 'https://github.com/Gopxfs/Pokemon-hunt',
  },
  {
